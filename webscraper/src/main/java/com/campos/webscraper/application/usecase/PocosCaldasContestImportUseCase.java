...
@Component
public class PocosCaldasContestImportUseCase extends AbstractMunicipalContestImportUseCase {

    private final PocosCaldasContestScraperStrategy strategy;

    @Autowired
    public PocosCaldasContestImportUseCase(
            PublicContestPostingRepository publicContestPostingRepository,
            PocosCaldasContestScraperStrategy strategy
    ) {
        this(
    ...
    protected String failurePrefix() {
        return "Poços de Caldas municipal scrape failed: ";
    }
}
