...
@Component
public class CamaraItajubaContestImportUseCase extends AbstractMunicipalContestImportUseCase {

    private final CamaraItajubaContestScraperStrategy strategy;

    @Autowired
    public CamaraItajubaContestImportUseCase(
            PublicContestPostingRepository publicContestPostingRepository,
            CamaraItajubaContestScraperStrategy strategy
    ) {
        this(
    ...
    protected String failurePrefix() {
        return "Itajubá Câmara scrape failed: ";
    }
}
