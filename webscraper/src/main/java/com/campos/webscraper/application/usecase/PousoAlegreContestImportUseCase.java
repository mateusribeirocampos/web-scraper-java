 ...
 */
@Component
public class PousoAlegreContestImportUseCase {
    ...
    public PousoAlegreContestImportUseCase(
        ...
        this.publicContestPostingRepository = Objects.requireNonNull(publicContestPostingRepository,
    ...
    public List<PublicContestPostingEntity> execute(
        ...
        if (!scrapeResult.success()) {
            throw new IllegalStateException("Pouso Alegre scrape failed: " + scrapeResult.errorMessage());
        }
