...
/**
 * End-to-end use case for importing Lever jobs through the strategy and persisting them.
 */
@Component
public class LeverJobImportUseCase {

    private final JobPostingRepository jobPostingRepository;
    private final LeverJobScraperStrategy strategy;
    ...
    public LeverJobImportUseCase(
            JobPostingRepository jobPostingRepository,
            LeverJobScraperStrategy strategy,
    ...
    public List<JobPostingEntity> execute(
        ...
        if (!result.success()) {
            throw new IllegalStateException("Lever scrape failed: " + result.errorMessage());
        }
