...
/**
 * Selected Greenhouse board plus the onboarding evidence required for activation.
 */
public record GreenhouseBoardOnboardingProfile(
        String boardToken,
        String jobsApiUrl,
    ...
    public GreenhouseBoardOnboardingProfile {
